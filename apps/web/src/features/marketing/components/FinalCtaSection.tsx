function FinalCtaSection() {
  return (
    <section className="px-4 py-20 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl rounded-2xl bg-[radial-gradient(circle_at_top_left,rgba(255,92,122,0.18),transparent_34%),radial-gradient(circle_at_bottom_right,rgba(0,255,209,0.14),transparent_30%),#111018] px-6 py-12 text-center shadow-2xl shadow-black/40 sm:px-10">
